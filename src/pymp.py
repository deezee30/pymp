...
if __name__ == "__main__":
    ...
    parser.add_argument("--pct", type=int, default=0, required=False, help="Percentage increase from buy price at which to sell")
    ...
    coin = input("Ready. Awaiting coin input: ").upper() # pump coin
